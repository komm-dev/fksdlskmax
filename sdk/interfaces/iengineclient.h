...
public:
	...
	std::optional< PlayerInfo_t > GetPlayerInfo(int nEntityIndex)
	{
		PlayerInfo_t info{ };
		if ( !MEM::CallVFunc<bool>( this, 8, nEntityIndex, &info ) )
			return std::nullopt;
	...
	bool IsActiveApp( )
	{
		return MEM::CallVFunc<bool>( this, 196 );
	}
	...
	void FireEvents( )
	{
		return MEM::CallVFunc<void>( this, 59 );
	}

	INetChannelInfo* GetNetChannelInfo() // thatsgood
	{
	...
	bool IsPaused()
	{
		return MEM::CallVFunc<bool>(this, 90);
	}
